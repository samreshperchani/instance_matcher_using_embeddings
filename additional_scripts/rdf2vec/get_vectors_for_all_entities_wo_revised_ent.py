...
print('loading model')
model = Word2Vec.load('model_new/RDF2Vec_final_en_all_v2.model', mmap='r')
...
df_commons = pd.merge(df_gs_entties, df_vocab, how='inner', left_on=['entity_id'], right_on=['entity_id'])
...
df_commons.to_pickle('all_ent_wo_revised_rdf2vec_vector_16092019.pkl')